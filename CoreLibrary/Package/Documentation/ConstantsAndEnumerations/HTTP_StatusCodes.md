...
console.log(HTTP_StatusCodes.created); // 200
...
console.log(HTTP_StatusCodes.requestEntityTooLarge); // 413
console.log(HTTP_StatusCodes.requestURL_TooLong); // 414
console.log(HTTP_StatusCodes.unsupportedMediaType); // 415
console.log(HTTP_StatusCodes.requestedRangeNotSatisfiable); // 416
