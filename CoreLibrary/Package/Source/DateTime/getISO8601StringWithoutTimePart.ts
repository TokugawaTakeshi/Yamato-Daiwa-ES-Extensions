...
export default function getISO8601StringWithoutTimePart(
  ...
  if ("ISO8601Definition" in sourceDataAndOptions) {
    ...
    if (
      sourceDataAndOptions.ISO8601Definition.length <= CHARACTERS_COUNT_OF_DATE_PART_IN_ISO8601_STRING &&
      ...
      nativeDateInstance = new Date(
        `${ sourceDataAndOptions.ISO8601Definition.substring(0, CHARACTERS_COUNT_OF_DATE_PART_IN_ISO8601_STRING) }T00:00`
      );
    ...
    return nativeDateInstance.toISOString().substring(0, CHARACTERS_COUNT_OF_DATE_PART_IN_ISO8601_STRING);
  ...
  return sourceDataAndOptions.nativeDateInstance.
    toISOString().
    substring(0, CHARACTERS_COUNT_OF_DATE_PART_IN_ISO8601_STRING);
