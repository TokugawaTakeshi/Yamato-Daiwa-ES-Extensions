    ...
    Logger.throwErrorAndLog({
      errorInstance: new InvalidParameterValueError({
        ...
        messageSpecificPart:
            ...
            "● \"startingElementNumber__numerationFrom1\": must the natual number\n" +
    ...
    Logger.throwErrorAndLog({
      errorInstance: new InvalidParameterValueError({
        ...
        messageSpecificPart:
            ...
            "The valid alternatives are:\n" +
            "● \"endingElementNumber__numerationFrom0\": must the positive integer\n" +
            "● \"endingElementNumber__numerationFrom1\": must the natual number\n" +
            "● \"elementsCount\": must the natual number\n" +
