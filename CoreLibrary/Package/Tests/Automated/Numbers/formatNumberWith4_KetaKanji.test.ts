import { formatNumberWith4_KetaKanji, Logger } from "../../../Source";
  ...
  Testing.test(
    ...
    (): void => {
      [ 2, 34, 452, 5634 ].forEach((number: number): void => {
        Assert.strictEqual(formatNumberWith4_KetaKanji(number), String(number));
      });
    }
  ),
  ...
  Testing.test(
    ...
    (): void => {
      ...
      const testingSet: Array<[ number, string ]> = [
        ...
        [ 12345.43, "1万2345.43" ],
        [ 123456, "12万3456" ],
        [ 123456.25, "12万3456.25" ],
        [ 1234567, "123万4567" ],
        [ 1234567.8, "123万4567.8" ],
        [ 12345678, "1234万5678" ],
        [ 12345678.325, "1234万5678.325" ],
        [ -12345, "-1万2345" ],
        [ -12345.38, "-1万2345.38" ],
        [ -123456.153, "-12万3456.153" ],
        [ -1234567.75, "-123万4567.75" ],
        [ -12345678.2, "-1234万5678.2" ]
      ];

      testingSet.forEach(
        ([ number, formattedNumber ]: Readonly<[ number, string ]>): void => {
          Assert.strictEqual(formatNumberWith4_KetaKanji(number), formattedNumber);
        }
      );
  ...
  Testing.test(
    ...
    (): void => {
      ...
      const testingSet: Array<[ number, string ]> = [
        ...
        [ 123456789.32, "1億2345万6789.32" ],
        [ 1234567890, "12億3456万7890" ],
        [ 1234567890.6, "12億3456万7890.6" ],
        [ 12345678901, "123億4567万8901" ],
        [ 12345678901.18, "123億4567万8901.18" ],
        [ 123456789012, "1234億5678万9012" ],
        [ 123456789012.1, "1234億5678万9012.1" ],
        [ -123456789, "-1億2345万6789" ],
        [ -123456789.32, "-1億2345万6789.32" ],
        [ -1234567890, "-12億3456万7890" ],
        [ -1234567890.6, "-12億3456万7890.6" ],
  ...
  Testing.test(
    ...
    (): void => {
      ...
      const testingSet: Array<[ number, string ]> = [
        ...
        [ 1234567890123.43, "1兆2345億6789万0123.43" ],
        [ 12345678901234, "12兆3456億7890万1234" ],
        [ 12345678901234.5, "12兆3456億7890万1234.5" ],
  ...
  Testing.test(
    ...
    (): void => {
      ...
      const testingSet: Array<[ string | bigint, string ]> = [
        ...
        [ "12345678901234567.32", "1京2345兆6789億0123万4567.32" ],
        [ "123456789012345678", "12京3456兆7890億1234万5678" ],
        [ "123456789012345678.54", "12京3456兆7890億1234万5678.54" ],
        [ "1234567890123456789", "123京4567兆8901億2345万6789" ],
        [ "1234567890123456789.276", "123京4567兆8901億2345万6789.276" ],
        [ "12345678901234567890", "1234京5678兆9012億3456万7890" ],
        [ "12345678901234567890.854", "1234京5678兆9012億3456万7890.854" ],
        [ -12345678901234567n, "-1京2345兆6789億0123万4567" ],
        [ -123456789012345678n, "-12京3456兆7890億1234万5678" ],
        [ -1234567890123456789n, "-123京4567兆8901億2345万6789" ],
        [ -12345678901234567890n, "-1234京5678兆9012億3456万7890" ],
      ...
      testingSet.forEach(
        ([ stringifiedNumber, formattedNumber ]: Readonly<[ string | bigint, string ]>): void => {
          Assert.strictEqual(formatNumberWith4_KetaKanji(stringifiedNumber), formattedNumber);
        }
      );
  ...
  Testing.test(
    ...
    (): void => {
      ...
      const testingSet: Array<[ string | bigint, string ]> = [
        ...
        [ "123456789012345678901.64", "12345京6789兆0123億4567万8901.64" ],
        [ BigInt("1234567890123456789012"), "123456京7890兆1234億5678万9012" ],
        [ "1234567890123456789012", "123456京7890兆1234億5678万9012" ],
        [ "1234567890123456789012.382", "123456京7890兆1234億5678万9012.382" ]
      ];
