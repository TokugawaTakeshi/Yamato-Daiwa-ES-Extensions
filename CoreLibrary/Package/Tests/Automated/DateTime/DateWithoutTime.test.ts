...
describe("DateWithoutTime", (): void => {
  ...
  describe("Constructor", (): void => {
    ...
    it("Native", (): void => {
      ...
      const sample2: DateWithoutTime = new DateWithoutTime(new Date(2014, 11, 1));
    ...
    it("Milliseconds amount", (): void => {

      const nativeDate: Date = new Date(2013, 0, 8);
      const millisecondsAmount: number = nativeDate.getTime();
      const dateWithoutTime: DateWithoutTime = new DateWithoutTime(millisecondsAmount);
