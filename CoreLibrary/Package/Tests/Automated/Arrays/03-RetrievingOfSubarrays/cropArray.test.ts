      ...
      Testing.suite(
        ...
        async (): Promise<void> => {
          ...
          await Promise.all([
            ...
            Testing.suite(
              "With `rightElementNumber__numerationFrom1_AndRight` ...",
              async (): Promise<void> => {
                              ...
                              Testing.test(
                                ...
                                (): void => {
                                  ...
                                  cropArray({
                                    targetArray: sample,
                                    fromEnd: true,
                                    rightElementNumber__numerationFrom1_AndRight: 2,
                                    leftElementNumber__numerationFrom0_AndRight__including: 3,
                                    mustThrowErrorIfSpecifiedElementsNumbersAreOutOfRange: true,
                                    mutably: true
                                  });
                                        ...
                                        Assert.throws(
                                          (): void => {
                                            cropArray({
                                              targetArray: generateConstantSample(),
                                              fromEnd: true,
                                              rightElementNumber__numerationFrom1_AndRight: 4,
                                              leftElementNumber__numerationFrom0_AndRight__including: 6,
                                              mustThrowErrorIfSpecifiedElementsNumbersAreOutOfRange: true,
                                              mutably: true
                                            });
                            ...
                            await Testing.test(
                              ...
                              (): void => {
                                ...
                                cropArray({
                                  targetArray: sample,
                                  fromEnd: true,
                                  rightElementNumber__numerationFrom1_AndRight: 3,
                                  untilLeftmostElement: true,
                                  mustThrowErrorIfSpecifiedElementsNumbersAreOutOfRange: true,
                                  mutably: true
                                });
                                  ...
                                  await Promise.all([
                                    ...
                                    Testing.test(
                                      ...
                                      (): void => {
                                        ...
                                        Assert.deepStrictEqual(sample, [ "ALPHA", "BRAVO", "CHARLIE", "DELTA", "ECHO" ]);
                                ...
                                async (): Promise<void> => {
                                  ...
                                  await Promise.all([
                                    Testing.test(
                                      "Cropped Array is Matching with Expected One",
                                      (): void => {
                                        Assert.deepStrictEqual(croppedArray, [ "BRAVO", "CHARLIE", "DELTA", "ECHO" ]);
                                      }
                                    ),
                                    Testing.test(
                                      "Source Array has Not Changed",
                                ...
                                async (): Promise<void> => {
                                  ...
                                  await Promise.all([
                                    Testing.test(
                                      "Cropped Array is Matching with Expected One",
                                      (): void => {
                                        Assert.deepStrictEqual(croppedArray, [ "DELTA", "ECHO" ]);
                                      }
                                    ),
                                    Testing.test(
                                      "Source Array has Not Changed",
                              ...
                              async (): Promise<void> => {
                                ...
                                await Promise.all([
                                  Testing.test(
                                    "Cropped Array is Matching with Expected One",
                                    (): void => {
                                      Assert.deepStrictEqual(croppedArray, [ "ALPHA", "BRAVO", "CHARLIE", "DELTA", "ECHO" ]);
                                    }
                                  ),
                                  Testing.test(
                                    "Source Array has Not Changed",
