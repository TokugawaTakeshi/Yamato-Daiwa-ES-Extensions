...
export { default as createColumnVectorFrom2DimensionalArray } from "./Operations/createColumnVectorFrom2DimensionalArray";
...
export { default as performElementWiseOperationOnMatrices } from "./Operations/performElementWiseOperationOnMatrices";
