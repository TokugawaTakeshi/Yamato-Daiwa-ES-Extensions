...
export default function formatNumberWith4KetaKanji(targetNumber: number | bigint | string): string {
  ...
  const NUMBER_DIGITS_SEPARATION__SYMBOLS_COUNT: number = 4;
  ...
  const MANS_FIRST_DIGITS_NUMBER__BEGINNING_FROM_0: number = NUMBER_DIGITS_SEPARATION__SYMBOLS_COUNT;
  const OKUS_FIRST_DIGITS_NUMBER__BEGINNING_FROM_0: number =
      MANS_FIRST_DIGITS_NUMBER__BEGINNING_FROM_0 + NUMBER_DIGITS_SEPARATION__SYMBOLS_COUNT;
  const TYOUS_FIRST_DIGITS_NUMBER__BEGINNING_FROM_0: number =
      OKUS_FIRST_DIGITS_NUMBER__BEGINNING_FROM_0 + NUMBER_DIGITS_SEPARATION__SYMBOLS_COUNT;
  const KEIS_FIRST_DIGITS_NUMBER__BEGINNING_FROM_0: number =
      TYOUS_FIRST_DIGITS_NUMBER__BEGINNING_FROM_0 + NUMBER_DIGITS_SEPARATION__SYMBOLS_COUNT;
  const REMAIN_DIGITS_START_POSITION__BEGINNING_FROM_0: number =
      KEIS_FIRST_DIGITS_NUMBER__BEGINNING_FROM_0 + NUMBER_DIGITS_SEPARATION__SYMBOLS_COUNT;

  const lastFourDigits: string = reverseString(targetNumber__reversed.substr(0, NUMBER_DIGITS_SEPARATION__SYMBOLS_COUNT));
